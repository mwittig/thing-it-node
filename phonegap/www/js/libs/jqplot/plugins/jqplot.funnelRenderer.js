...
(function($) {
    ...
    //                     this._elem.mobile-angular-ui-ui('left', a);
    //                     this._elem.mobile-angular-ui-ui('top', b);
    //                     break;
    //                 case 'n':
    ...
    //                     var b = grid._top + this.yoffset;
    //                     this._elem.mobile-angular-ui-ui({right:a, top:b});
    //                     break;
    //                 case 'e':
    //                     var a = offsets.right + this.xoffset;
    ...
    //                     this._elem.mobile-angular-ui-ui({right:a, bottom:b});
    //                     break;
    //                 case 's':
    //                     var a = (offsets.left + (this._plotDimensions.width - offsets.right))/2 - this.getWidth()/2;
    //                     var b = offsets.bottom + this.yoffset;
    //                     this._elem.mobile-angular-ui-ui({left:a, bottom:b});
    //                     break;
    //                 case 'sw':
    //                     var a = grid._left + this.xoffset;
    //                     var b = offsets.bottom + this.yoffset;
    ...
    //                     var a = grid._left + this.xoffset;
    //                     var b = (offsets.top + (this._plotDimensions.height - offsets.bottom))/2 - this.getHeight()/2;
    //                     this._elem.mobile-angular-ui-ui({left:a, top:b});
    //                     break;
    //                 default:  // same as 'se'
    ...
    //                     var b = grid._top + this.yoffset;
    //                     this._elem.mobile-angular-ui-ui('right', a);
    //                     this._elem.mobile-angular-ui-ui('top', b);
    //                     break;
    //                 case 'n':
    //                     var a = (offsets.left + (this._plotDimensions.width - offsets.right))/2 - this.getWidth()/2;
    ...
    //                     this._elem.mobile-angular-ui-ui('left', a);
    //                     this._elem.mobile-angular-ui-ui('bottom', b);
    //                     break;
    //                 case 'ne':
