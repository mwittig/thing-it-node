...
function Camera() {
    ...
    Camera.prototype.flipImage = function () {
        fs.createReadStream(__dirname + "/data/snapshotImage" + (this.imageIndex + 1) + ".png").pipe(fs.createWriteStream(__dirname + "/../../" + this.node.options.dataDirectory + "/devices/" + this.id + "/snapshotImage" + (this.rotateIndex + 1) + ".png"));
