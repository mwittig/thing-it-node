...
[![NPM](https://nodei.co/npm/thing-it-device-occupancy-sensor.png)](https://nodei.co/npm/thing-it-device-occupancy-sensor/)
[![NPM](https://nodei.co/npm-dl/thing-it-device-occupancy-sensor.png)](https://nodei.co/npm/thing-it-device-occupancy-sensor/)

[thing-it-node] Device Plugin for a generic Occupancy Sensor. Manufacturers of these sensors may use this as an example to implement
a [thing-it-node] Device Plugin for their sensor products.
...
The **[thing-it-device-occupancy-sensor]** Plugin is installed with **[thing-it-node]**, hence there is no need to install it separately.
...
```
mkdir ~/occupancy-sensor-test
cd ~/occupancy-sensor-test
```
...
```
tin example --device occupancy-sensor
```
