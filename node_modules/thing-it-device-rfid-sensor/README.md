# thing-it-device-rfid-sensor

[![NPM](https://nodei.co/npm/thing-it-device-rfid-sensor.png)](https://nodei.co/npm/thing-it-device-rfid-sensor/)
[![NPM](https://nodei.co/npm-dl/thing-it-device-rfid-sensor.png)](https://nodei.co/npm/thing-it-device-rfid-sensor/)

[thing-it-node] Device Plugin for a generic RFID Reader. Manufacturers of RFID readers may use this as an example to implement
a [thing-it-node] Device Plugin for their products.
...
The **[thing-it-device-rfid-sensor]** Plugin is installed with **[thing-it-node]**, hence there is no need to install it separately.
...
```
tin example --device rfid-sensor
```
