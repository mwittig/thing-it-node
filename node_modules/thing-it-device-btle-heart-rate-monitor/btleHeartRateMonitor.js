module.exports = {
    ...
    create: function (device) {
        return new BtleHeartRateMonitor();
    },
    discovery: function (options) {
        var discovery = new BtleHeartRateMonitorDiscovery();
...
function BtleHeartRateMonitorDiscovery() {
    /**
     *
     * @param options
     */
    BtleHeartRateMonitorDiscovery.prototype.start = function () {
        if (this.node.isSimulated()) {
            ...
            noble.on('discover', function (peripheral) {
                if (peripheral.advertisement.localName &&
                    ...
                    var heartRateMonitor = new BtleHeartRateMonitor();
     ...
     * @param options
     */
    BtleHeartRateMonitorDiscovery.prototype.stop = function () {
        noble.stopScanning();
    };
}
 ...
 *
 */
function BtleHeartRateMonitor() {
    /**
     *
     */
    BtleHeartRateMonitor.prototype.start = function () {
     ...
     *
     */
    BtleHeartRateMonitor.prototype.connect = function () {
    ...
    BtleHeartRateMonitor.prototype.getBodySensorData = function (callback) {
    ...
    BtleHeartRateMonitor.prototype.bodyLocationToString = function (location) {
     ...
     *
     */
    BtleHeartRateMonitor.prototype.setState = function (state) {
        this.state = state;
    };
     ...
     *
     */
    BtleHeartRateMonitor.prototype.getState = function () {
        return this.state;
    };
}
