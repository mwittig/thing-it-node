...
[![NPM](https://nodei.co/npm/thing-it-ti-sensortag.png)](https://nodei.co/npm/thing-it-device-ibeacon/)
[![NPM](https://nodei.co/npm-dl/thing-it-device-ibeacon.png)](https://nodei.co/npm/thing-it-device-ibeacon/)

[thing-it-node] Device Plugin for [iBeacon]()

<img src="./documentation/images/ibeacon.jpeg" width="40%">

This allows you to 

* configured distributed iBeacons,
