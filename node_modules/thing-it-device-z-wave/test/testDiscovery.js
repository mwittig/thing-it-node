...
var ZWAVENETWORK = require('../zWaveNetwork');

var zWaveNetworkDiscovery = ZWAVENETWORK.discovery({});
console.log(zWaveNetworkDiscovery);

zWaveNetworkDiscovery.isSimulated = function () {
    return false;
};

zWaveNetworkDiscovery.defaultConfiguration = [];

zWaveNetworkDiscovery.node = {
    options: {dataDirectory: "/Users/Klaus/tin/data"}, isSimulated: function () {
        return false
    }
};

zWaveNetworkDiscovery.logInfo = function () {
...
zWaveNetworkDiscovery.logDebug = function () {
    zWaveNetworkDiscovery.logInfo(arguments);
};

zWaveNetworkDiscovery.logError = function () {
    zWaveNetworkDiscovery.logInfo(arguments);
};

zWaveNetworkDiscovery.advertiseDevice = function (device) {
