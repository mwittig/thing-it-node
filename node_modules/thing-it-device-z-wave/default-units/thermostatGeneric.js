...
function ThermostatGeneric() {
    ...
    ThermostatGeneric.prototype.setStateFromZWave = function (comClass, command) {
        if (comClass == 32) { // Basic
            ...
            this.state.temperature = parseFloat(command.value);
            ...
            this.state.setpoint = parseFloat(command.value);
            this.state.units = command.units;
    ...
    ThermostatGeneric.prototype.incrementSetpoint = function () {
        ...
        if (this.isSimulated()) {
            ...
            if (this.device.nodes[this.configuration.nodeId]) {
                this.device.zWave.setValue(this.configuration.nodeId, 67, 1, 2, "" + (this.state.setpoint + 0.5));
                this.publishStateChange();
            }
            else {
     ...
     *
     */
    ThermostatGeneric.prototype.toggleFanMode = function () {
        this.logDebug("Called toggleFanMode()");
    };
}
