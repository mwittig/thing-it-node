var app = angular.module('ThingItMobile', [
    ...
    "ThingItMobile.PluginDirectives",
    'ThingItMobile.Main'
]);
...
app.config(function ($routeProvider) {
    ...
    $routeProvider.when('/deviceConfigurationDialog', {
        templateUrl: 'deviceConfigurationDialog.html',
        reloadOnSearch: false
    });
    $routeProvider.when('/actorConfiguration', {templateUrl: 'actorConfigurationPage.html', reloadOnSearch: false});
    $routeProvider.when('/actorConfigurationDialog', {
        templateUrl: 'actorConfigurationDialog.html',
        reloadOnSearch: false
    });
    $routeProvider.when('/sensorConfiguration', {templateUrl: 'sensorConfigurationPage.html', reloadOnSearch: false});
    $routeProvider.when('/sensorConfigurationDialog', {
        templateUrl: 'sensorConfigurationDialog.html',
        reloadOnSearch: false
    });
    ...
    $routeProvider.when('/notifications', {templateUrl: 'notificationsPage.html', reloadOnSearch: false});
});
