...
app.directive('tiTriState', function ($timeout, $parse) {
    return {
        restrict: "E",
...
app.directive('tiAudio', function () {
    return {
        restrict: "E",
...
app.directive('tiVideo', function () {
    return {
        restrict: "E",
...
app.directive('tiKnob', function ($timeout, $parse) {
    return {
        link: function (scope, element, attrs) {
...
app.directive('tiSlider', function ($timeout, $parse) {
    return {
        link: function (scope, element, attrs) {
...
app.directive('tiSwitch', function ($timeout, $parse) {
    return {
        restrict: "E",
...
app.directive('tiBattery', function ($timeout, $parse) {
    return {
        restrict: "E",
        link: function (scope, element, attrs) {
...
app.directive('tiDrone', function ($timeout, $parse) {
    return {
        restrict: "E",
        link: function (scope, element, attrs) {
...
app.directive('tiColorPicker', function ($timeout, $parse) {
    return {
        restrict: "E",
