...
<div class="scrollable" ui-state="searchBar">
    <div class="scrollable-content" ui-scroll-bottom='bottomReached()' ui-swipe-right="mobileConsole.popPage()">
        <div class="list-group">
            ...
            <div ng-repeat="group in mobileConsole.topPage().node.groups"
            ...
            <div ng-repeat="service in mobileConsole.topPage().node.services"
                 ng-click="mobileConsole.callNodeService(mobileConsole.topPage().node, service)" class="list-group-item listGroupItem">
