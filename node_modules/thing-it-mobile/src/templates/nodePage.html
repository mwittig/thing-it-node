<div ui-content-for="topbar">
    ...
    <div class="btn-group pull-left">
        <div class="btn">
            <a ng-show="mobileConsole.settings.server == 'local'" ng-click="mobileConsole.logout()"><i
                    class="icon sl-power-1"></i></a>
            <a ng-hide="mobileConsole.settings.server == 'local'" ng-click="mobileConsole.popPage()">
    ...
    <div class="scrollable-content" ui-scroll-bottom='bottomReached()' ui-swipe-right="mobileConsole.popPage()">
        <div class="list-group">
            ...
            <a ng-repeat="device in mobileConsole.topPage().node.devices" class="list-group-item"
               ng-show="device.__type.tangible && !mobileConsole.isDeviceInGroups(mobileConsole.topPage().node, device)" ui-swipe-left="mobileConsole.pushDevicePage(device)">
            ...
            <a ng-repeat="actor in mobileConsole.topPage().actors"
               class="list-group-item" ng-show="!mobileConsole.isActorInGroups(mobileConsole.topPage().node, actor)" ui-swipe-left="mobileConsole.pushActorPage(actor)">
            ...
            <a ng-repeat="sensor in mobileConsole.topPage().sensors"
               class="list-group-item" ng-show="!mobileConsole.isSensorInGroups(mobileConsole.topPage().node, sensor)" ui-swipe-left="mobileConsole.pushSensorPage(sensor)">
