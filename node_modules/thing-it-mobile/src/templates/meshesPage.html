<div ui-content-for="topbar">
    <div class="navbar-brand navbar-brand-center">
        <i class="icon sl-globe-1"></i> Meshes
    </div>
    <div class="btn-group pull-left">
        <div class="btn">
            <a ng-click="mobileConsole.logout()"><i class="icon sl-power-1"></i></a>
        </div>
    </div>
...
<div class="scrollable" ui-state="searchBar">
    <div class="scrollable-content" ui-scroll-bottom='bottomReached()'>
        <div class="list-group">
            <div ng-repeat="mesh in mobileConsole.topPage().meshes track by $index"
                 ng-click="mobileConsole.pushMeshPage(mesh)" class="list-group-item listGroupItem">
                <div class="titleIcon"><i
                        class="icon sl-network-2"></i></div>
                <div class="content">{{mesh.label}}</div>
