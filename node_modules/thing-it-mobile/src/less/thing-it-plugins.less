...
@keyframes circleButtonClick {
  0% {
    background: lighten(@contrastColor, @lightPercentage);
    -webkit-box-shadow: 1px 1px 1px 0px lighten(@contrastColor, @lightPercentage) !important;
    -moz-box-shadow: 1px 1px 1px 1px lighten(@contrastColor, @lightPercentage) !important;
    -o-box-shadow: 1px 1px 1px 1px lighten(@contrastColor, @lightPercentage) !important;
    box-shadow: 1px 1px 1px 0px lighten(@contrastColor, @lightPercentage) !important;
  }
  100% {
    background: #FFFFFF;
...
@-webkit-keyframes circleButtonClick {
  0% {
    background: lighten(@contrastColor, @lightestPercentage);
  }
  100% {
    background: #FFFFFF;
  }
