...
gulp.task('css', function () {
    return gulp.src(config.vendor.css.prepend)
...
gulp.task('js', function () {
    streamqueue({objectMode: true},
        ...
        gulp.src(['src/templates/**/*.html']).pipe(templateCache({module: 'ThingItMobile'}))
    )
...
gulp.task('build', function (done) {
    var tasks = ['html', 'fonts', 'res', 'css', 'images', 'less', 'js'];
