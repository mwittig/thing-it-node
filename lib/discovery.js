    ...
    Discovery.prototype.advertiseDevice = function (newDevice) {
        for (var n in this.node.devices) {
            if (newDevice.uuid === this.node.devices[n].uuid &&
                ...
                console.log("\tRejecting discovered Device " + newDevice.uuid + " (" + this.deviceTypePlugin + ") as it is already registered/configured.");
        ...
        newDevice.configuration = this.defaultConfiguration;
