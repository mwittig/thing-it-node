module.exports = {
    bind: function (node, eventProcessor) {
        ...
        if (eventProcessor.trigger.type == "timeInterval") {
            eventProcessor.interval = eventProcessor.trigger.content.interval; // TODO Legacy?
        ...
        if (eventProcessor.action.type == "script") {
            eventProcessor.callbackScript = node
                .preprocessScript(eventProcessor.action.content.script);
        } else if (eventProcessor.action.type == "nodeService") {
            eventProcessor.callbackScript = node
                .preprocessScript(eventProcessor.action.content.service + "();");
        } else if (eventProcessor.action.type == "deviceService") {
            eventProcessor.callbackScript = node
                .preprocessScript(eventProcessor.action.content.device + "."
                + eventProcessor.action.content.service + "();");
        } else if (eventProcessor.service.type == "actorService") {
            eventProcessor.callbackScript = node
                .preprocessScript(eventProcessor.action.content.device + "." + eventProcessor.action.content.actor + "."
                + eventProcessor.action.content.service + "();");
        }

        eventProcessor.logDebug("Action preprocessed: " + eventProcessor.callbackScript);
