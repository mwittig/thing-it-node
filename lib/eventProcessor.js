...
function EventProcessor() {
    ...
    EventProcessor.prototype.bind = function (node) {
        ...
        if (this.trigger.content.cumulation && this.trigger.content.stateVariable) {
     ...
     * @param endOfInterval
     */
    EventProcessor.prototype.evaluate = function (endOfInterval) {
        ...
        if (matchingConditions.length == this.trigger.content.conditions.length) {
            ...
            this.logDebug("Onetime condition matched. Restarting interval.");
