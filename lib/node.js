...
function Node() {
    ...
    Node.prototype.initializeReverseProxy = function () {
        ...
        var reverseProxyNamespace = this.options.reverseProxy + "/reverse-proxy/nodes/" + this.uuid;
    ...
    Node.prototype.start = function (app, io) {
        ...
        if (this.options.reverseProxy) {
            this.reverseProxyNamespace = this.io.of(this.options.reverseProxy + "/reverse-proxy/nodes/" + this.uuid + "/server/events");
        }
