                                    ...
                                    try {
                                        ...
                                        if ((details = this.matchRequestPath(request.path, "/firmware")) && request.method === "POST") {
                                            ...
                                            this.reverseProxyNamespace.emit("httpResponse", {
                                                uuid: request.uuid,
                                                status: 0,
                                                data: this.node[this.mangleId(details.params.node, details.params.data)]
                                            });
                                        }
                                            ...
                                            this.node.findData(this.mangleId(details.params.node, details.params.data)).update(value).then(function () {
                                                this.reverseProxyNamespace.emit("httpResponse", {
                                                    uuid: request.uuid,
                                                    status: 0
                                                });
