    ...
    NodeManager.prototype.loadNodeConfigurations = function () {
        ...
        for (var n in list) {
            ...
            if (fileStat && fileStat.isFile()) {
                ...
                this.meshesMap[nodeConfiguration.uuid] = nodeConfiguration.mesh;
...
function Node() {
    ...
    Node.prototype.publishDeviceEvent = function (device, event, data, relatedId) {
        ...
        if (this.reverseProxyNamespace) {
            this.logDebug("Mesh", this.__nodeManager.this.meshesMap[this.__nodeManager.extractNodeUuid(device.id)]);

            this.reverseProxyNamespace.emit("deviceEvent", {
                mesh: this.__nodeManager.this.meshesMap[this.__nodeManager.extractNodeUuid(device.id)],
