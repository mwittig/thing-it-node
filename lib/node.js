...
var scriptService = require("./scriptService");
var remoteNodeService = require("./remoteNodeService");
var externalRestService = require("./externalRestService");
...
function NodeManager() {
                ...
                for (var m in pluginFiles) {
                    ...
                    if (fileStat && fileStat.isFile()) {
                        ...
                        try {
                            ...
                            this.logInfo("Failed to load plugin [" + devicePath
                                + "]:");
                            this.logInfo(x);
                        }
                    }
        ...
        for (var m in pluginFiles) {
            ...
            if (fileStat && fileStat.isFile()) {
                ...
                try {
                    ...
                    this.logInfo("Failed to load Unit Plugin [" + unitPath + "]:");
                    this.logInfo(x);
                }
            }
        }
    ...
    NodeManager.prototype.configure = function (node) {
        ...
        this.node.initialize(this.devicePlugins, this.options.simulated, options.logLevel);
...
function Node() {
    ...
    Node.prototype.start = function () {
        ...
        for (var n in this.services) {
            ...
            } else if (this.services[n].type === "externalRestService") {
                externalRestService.bind(this, this.services[n]);
            } else if (this.services[n].type === "remoteNodeService") {
                remoteNodeService.bind(this, this.services[n]);
            } else {
                scriptService.bind(this, this.services[n]);
            }
        }
