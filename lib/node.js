...
function NodeManager() {
    ...
    NodeManager.prototype.saveNodeConfiguration = function (uuid) {
        ...
        this.logDebug("ID " + this.configurationsMap[uuid].configuration.id);
...
function Node() {
    ...
    Node.prototype.createDevice = function (newDevice) {
        ...
        newDevice.id = nodeManager.mangleId(nodeManager.defaultNodeConfiguration.uuid, newDevice.id);
    ...
    Node.prototype.createService = function (newService) {
        var deferred = q.defer();
        newService.id = nodeManager.mangleId(nodeManager.defaultNodeConfiguration.uuid, newService.id);
    ...
    Node.prototype.createGroup = function (newGroup) {
        var deferred = q.defer();
        newGroup.id = nodeManager.mangleId(nodeManager.defaultNodeConfiguration.uuid, newGroup.id);
    ...
    Node.prototype.createEventProcessor = function (newEventProcessor) {
        var deferred = q.defer();
        newEventProcessor.id = nodeManager.mangleId(nodeManager.defaultNodeConfiguration.uuid, newEventProcessor.id);
    ...
    Node.prototype.createStoryboard = function (newStoryboard) {
        var deferred = q.defer();
        newStoryboard.id = nodeManager.mangleId(nodeManager.defaultNodeConfiguration.uuid, newStoryboard.id);
    ...
    Node.prototype.createJob = function (newJob) {
        var deferred = q.defer();
        newJob.id = nodeManager.mangleId(nodeManager.defaultNodeConfiguration.uuid, newJob.id);
