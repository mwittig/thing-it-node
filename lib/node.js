module.exports = {
    ...
    create: function (node, app, io) {
        var nodeManager = new NodeManager();

        nodeManager.createNode(node, app, io);
...
function NodeManager() {
     ...
     *
     */
    NodeManager.prototype.createNode = function (node, app, io) {
        this.loadPlugins();
        ...
        this.initializeCommunicationBasis({simulated: true}, app, io, "/nodes/" + node.uuid);
