module.exports = {
    ...
    bootstrap: function (options, app, io, server) {
        ...
        if (options.proxy == "local") {
            ...
            utils.inheritMethods(node, new Node());
            node.initialize(options, app, io);
            node.start();
        }
        else {
            try {
                ...
                new Node().initialize(options, app, io);
 ...
 * @param node
 */
function saveNodeConfiguration(file, node) {
...
function Node() {
     ...
     *
     */
    Node.prototype.initialize = function (options, app, io) {
        this.initializeBasics(options, app, io)
     ...
     *
     */
    Node.prototype.initializeBasics = function (options, app, io) {
     ...
     *
     */
    Node.prototype.initializeWebSocket = function () {
     ...
     *
     */
    Node.prototype.initializeRestServices = function () {
            ...
            function (req, res) {
                self
                    ...
                    function () {
                        ...
                        saveNodeConfiguration(this.options.nodeConfigurationFile, node);
