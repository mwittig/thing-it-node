    ...
    NodeManager.prototype.initializeRestServices = function () {
        ...
        this.app.post("/devices", function (request, response) {
            if (!request.body.id) {
                ...
                response.status(500).send("No Device Plugin for Device.");
            }
        ...
        this.app.post("/devices/:device/actors", function (request, response) {
            if (!request.body.id) {
                ...
                response.status(500).send("No Actor Plugin for Actor.");
            }
        ...
        this.app.post("/devices/:device/sensors", function (request, response) {
            if (!request.body.id) {
                ...
                response.status(500).send("No Sensor Plugin for Sensor.");
            }
...
function Node() {
    ...
    Node.prototype.updateDevice = function (id, newDevice) {
        ...
        this.findDevice(id).stopDevice().then(function () {
            // TODO Remove device
            this.devices.push(newDevice);
