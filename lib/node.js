...
function NodeManager() {
    ...
    NodeManager.prototype.initializeReverseProxy = function () {
        ...
        this.connectInterval = setInterval(function () {
            console.log("" + new Date() + " (Re)try initial NS connection for " + reverseProxyNamespaceUrl);

            if (this.reverseProxyNamespace) {
                console.log("Remove all listeners on retry");
                this.reverseProxyNamespace.removeAllListeners();
            }

            getmac.getMac(function (error, macAddress) {
                if (error) {
                    console.error("Cannot retrieve MAC address: " + error);
                ...
                request.post({
                    ...
                    if (error) {
                        ...
                        console.log("" + new Date() + "Server notified", body);

                        if (body.paired) {
                            console.log("Node Box is paired on server.");
                            ...
                            this.reverseProxyNamespace.on("connect", function () {
                                ...
                                this.reverseProxyNamespace.on("disconnect", function (socket) {
                                    ...
                                    if (this.reverseProxyNamespace) {
                                        console.log("Removing all listeners on disconnect");
                                ...
                                this.reverseProxyNamespace.on("httpRequest", function (request) {
                                    console.log("Received Reverse Proxy HTTP Request: " + request.path);
                        ...
                        {
                            console.log("Node Box is unpaired - wait for pairing and retry.");
