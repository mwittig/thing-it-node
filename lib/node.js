...
function Node() {
    ...
    Node.prototype.publishDeviceAdvertisement = function (device) {
        try {
            this.logDebug("Publishing Device Advertisement on local namespace.", device);
            ...
            this.logDebug("Publishing Device Advertisement on Push Proxy.");
            this.logDebug("Extracting", this.__nodeManager.extractNodeUuid(device.id));
