...
function InfraredRemote() {
    ...
    InfraredRemote.prototype.enhanceBoard = function () {
        if (this.isSimulated()) {
            ...
            this.device.board = new Board();
        }

        this.device.board.sendInfraredCommand = function (command) {
        ...
        this.device.board.bindInfraredListener = function () {
        ...
        this.device.board.unbindInfraredListener = function () {
         ...
         */
        this.device.board.sendInfraredCommandSequenceRecursive = function (sequence, index) {
            var deferred = q.defer();
         ...
         * @param callback
         */
        this.device.board.loadChunkToEprom = function (chunk) {
            var deferred = q.defer();
         ...
         * @returns {promise|*|d.promise|Q.promise|n.ready.promise}
         */
        this.device.board.sendEpromToInfraredLed = function (commandSequence, index) {
            var deferred = q.defer();
    ...
    InfraredRemote.prototype.sendCommand = function (command) {
        return this.device.board.sendInfraredCommand(command);
    };
}
