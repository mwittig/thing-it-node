...
function Sensor() {
    ...
    Sensor.prototype.publishEvent = function (event, data) {
        ...
        this.device.node.publishSensorEvent(this.device, this, event, data);
    };
    ...
    Sensor.prototype.publishValueChangeEvent = function (data) {
        for (var n = 0; n < this.eventProcessors.length; ++n) {
            this.eventProcessors[n].notifyOnSensorValueChange(this, data);
        }
     ...
     *
     */
    Sensor.prototype.publishStateChange = function () {
        for (var n in this.eventProcessors) {
            this.eventProcessors[n].notifyOnSensorStateChange(this, this.state);
        }

        this.device.node.publishSensorStateChange(this.device, this, this.getState());
    };
