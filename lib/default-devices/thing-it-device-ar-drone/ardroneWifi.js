...
function ArDroneWifi() {
    ...
    ArDroneWifi.prototype.start = function () {
        ...
        if (self.isSimulated()) {
            ...
            self.drone = require('ar-drone').createClient({
    ...
    ArDroneWifi.prototype.takeOff = function () {
        if (this.isSimulated()) {
            console.log("HeartRateMonitor.takeOff");
        }
        else {
            this.drone.takeoff();
        }
    ...
    ArDroneWifi.prototype.land = function () {
        if (this.isSimulated()) {
            console.log("HeartRateMonitor.land");
        }
        else {
            this.drone.land();
        }
    ...
    ArDroneWifi.prototype.down = function () {
        if (this.isSimulated()) {
            console.log("UsbMicrophone.down");
    ...
    ArDroneWifi.prototype.clockwise = function () {
        if (this.isSimulated()) {
            console.log("UsbMicrophone.clockwise");
    ...
    ArDroneWifi.prototype.counterClockwise = function () {
        if (this.isSimulated()) {
            console.log("UsbMicrophone.counterClockwise");
    ...
    ArDroneWifi.prototype.front = function () {
        if (this.isSimulated()) {
            console.log("UsbMicrophone.front");
    ...
    ArDroneWifi.prototype.back = function () {
        if (this.isSimulated()) {
            console.log("UsbMicrophone.back");
    ...
    ArDroneWifi.prototype.left = function () {
        if (this.isSimulated()) {
            console.log("UsbMicrophone.left");
    ...
    ArDroneWifi.prototype.right = function () {
        if (this.isSimulated()) {
            console.log("UsbMicrophone.right");
