    ...
    Action.prototype.execute = function (input) {
        try {
            if (this.type === "script") {
                ...
                this.__node[this.content.service](this.parameters);
            }
            else if (this.type === "deviceService") {
                this.__node.findDevice(this.content.device)[this.content.service](this.parameters);
            }
                ...
                this.__node.findDevice(this.content.device).findActor(this.content.actor)[this.content.service](this.parameters);
            }
