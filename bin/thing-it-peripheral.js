                ...
                characteristics: [
                    new Characteristic({
                        ...
                        onWriteRequest: function (data, offset, withoutResponse, callback) {
                            ...
                            new ConfigurationManager().applyConfiguration(configuration);
...
ConfigurationManager.prototype.applyConfiguration = function (configuration) {
    ...
    var path = process.cwd() + '/test/wpa_supplicant.conf';
    var content = 'network={\n' +
    ...
    var path = process.cwd() + '/test/options.js';
    ...
    var path = process.cwd() + '/test/configurations/default.js';
    ...
    console.log('Restarting Gateway Computer.');
}